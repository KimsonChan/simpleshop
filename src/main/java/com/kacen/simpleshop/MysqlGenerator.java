...
public class MysqlGenerator {
    ...
    private static final String OUT_PATH = "E:\\projectfortest\\simpleshop";
    private static final String AUTHOR = "oKong";

    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/simpleshop?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia";
